...
LightCommon::LightCommon() : PositionWorldSpace(0, 0, 0, 1), Color(1, 1, 1, 1), Strength(1.0f), ConstantAttenuation(1.0f), LinearAttenuation(0.007f), QuadraticAttenuation(0.0002f), MaxDistance(100.0f), Rank(0.0f), Padding{ 0 }
{
...
DirectionalLight::DirectionalLight() : DirectionWorldSpace(0, 0, 0, 0), RotationWorldSpace(0, 0, 0, 0), Color(1, 1, 1, 1), Strength(1.0f), Rank(0.0f), NumCascades(1), Padding{ 0 }
{
...
LightProperties::LightProperties() : PointLightCount(0), SpotLightCount(0), DirectionalLightCount(0), SpotShadowCount(0), CascadeShadowCount(0), PointShadowCount(0)
{
...
LightProperties LightData::GetLightProperties()
{
    ...
    lightProperties.PointShadowCount = (uint32_t)SortedPointShadowMaps.size();
