...
PointLight::PointLight() : PositionWorldSpace(0, 0, 0, 1), Color(1, 1, 1, 1), Strength(1.0f), ConstantAttenuation(1.0f), LinearAttenuation(0.007f), QuadraticAttenuation(0.0002f), MaxDistance(500.0f), Rank(1.0f), Padding{ 0 }
{
...
DirectionalLight::DirectionalLight() : DirectionWorldSpace(0, 0, 0, 0), RotationWorldSpace(0, 0, 0, 0), Color(1, 1, 1, 1), Strength(1.0f), Rank(10.0f), Padding{ 0 }
{
