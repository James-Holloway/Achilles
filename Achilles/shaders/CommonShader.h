...
namespace CommonShader
{
    ...
    std::shared_ptr<Mesh> CommonShaderMeshCreation(aiScene* scene, aiNode* node, aiMesh* inMesh, std::shared_ptr<Shader> shader, Material& material, std::wstring meshPath);
}