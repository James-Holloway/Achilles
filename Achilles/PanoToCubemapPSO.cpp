...
PanoToCubemapPSO::PanoToCubemapPSO()
{
    ...
    defaultUAV = Application::AllocateDescriptors(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, 5);
    UINT descriptorHandleIncrementSize = Application::GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
    ...
    for (UINT i = 0; i < 5; ++i)
    {
        ...
        device->CreateUnorderedAccessView(nullptr, nullptr, &uavDesc, defaultUAV.GetDescriptorHandle(i));
    }
}